...
本站是由 [hugo](https://github.com/gohugoio/hugo) 构建的静态网站。通过 [Github Actions](https://github.com/z1un/blog.zjun.info/actions) + 阿里云全站加速的方式持续构建。我的[主页](https://zjun.info)和[在线工具](https://tools.zjun.info)网站是由 [4everland](https://4everland.org/) 实现的部署，基于星际文件系统 [IPFS](https://ipfs.io/)，拥抱去中心化和 Web 3.0。
