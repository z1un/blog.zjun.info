...
本站是由 [hugo](https://github.com/gohugoio/hugo) 构建的静态网站。我的[主页](https://zjun.info)、[博客](https://blog.zjun.info)和[在线工具](https://tools.zjun.info)网站都是是由 [4everland](https://hosting.4everland.org/#/?invite=VIIBED79) 实现的部署，基于星际文件系统 [IPFS](https://ipfs.io/)，拥抱去中心化和 Web 3.0。
