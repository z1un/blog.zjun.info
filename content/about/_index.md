...
本站是由 [hugo](https://github.com/gohugoio/hugo) 构建的静态网站，通过本地提交至 [Github](https://github.com/)，再由 [4everland](https://4everland.org/) 实现部署，基于星际文件系统 [IPFS](https://ipfs.io/)。拥抱去中心化和 Web 3.0，目前有一个已知问题：无法定制 404 页面。
